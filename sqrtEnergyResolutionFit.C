...
{        
  ...
  /**/
  //UPDATE resolution plots so that the x axis shows 1/sqrt(E_gen)
  ...
  TVectorT<float> sqrtGenEnergyMeans(numEnergyBins);
  TVectorT<float> sqrtGenEnergyMeanErrors(numEnergyBins);
  ...
  for(unsigned int i=0; i<numEnergyBins ; i++){
	  ...
	  sqrtGenEnergyMeanErrors[i] += 0.0;
	  sqrtGenEnergyMeans[i] += 1/(TMath::Sqrt(genEngs[i]) );
  ...
  TF1 * fitToEtaBinOneResolution = new TF1("fitToEtaBinOneResolution","[0]*x+[1]",0.03,0.20);
  TGraphErrors * chgdPionEResoNoTrackFirstEtaBin = new TGraphErrors(sqrtGenEnergyMeans, withoutTrackerFitSigmasFirstEtaBin, sqrtGenEnergyMeanErrors, withoutTrackerFitSigmaErrorsFirstEtaBin);
  chgdPionEResoNoTrackFirstEtaBin->SetTitle("#pi+ Energy Resolution #eta_{gen} = 1.6; 1/sqrt(E_{gen})  [1/sqrt(GeV)]; #sigma of #DeltaE/E");
  ...
  std::string outFirstGraphName = outputPlotDir + "chgdPionEResoNoTrackFirstEtaBin_nonlinear_horizontal_axis.gif"; 
  ...
  */
  ...
  TF1 * fitToEtaBinTwoResolution = new TF1("fitToEtaBinTwoResolution","[0]*x+[1]",0.03,0.20);
 
  TGraphErrors * chgdPionEResoNoTrackSecondEtaBin = new TGraphErrors(sqrtGenEnergyMeans, withoutTrackerFitSigmasSecondEtaBin, sqrtGenEnergyMeanErrors, withoutTrackerFitSigmaErrorsSecondEtaBin);
  chgdPionEResoNoTrackSecondEtaBin->SetTitle("#pi+ Energy Resolution #eta_{gen} = 1.9; 1/sqrt(E_{gen})  [1/sqrt(GeV)]; #sigma of #DeltaE/E");
  ...
  std::string outSecondGraphName = outputPlotDir + "chgdPionEResoNoTrackSecondEtaBin_nonlinear_horizontal_axis.gif"; 
...
*/
  ...
  TF1 * fitToEtaBinThreeResolution = new TF1("fitToEtaBinThreeResolution","[0]*x+[1]",0.03,0.20);

  TGraphErrors * chgdPionEResoNoTrackThirdEtaBin = new TGraphErrors(sqrtGenEnergyMeans, withoutTrackerFitSigmasThirdEtaBin, sqrtGenEnergyMeanErrors, withoutTrackerFitSigmaErrorsThirdEtaBin);
  chgdPionEResoNoTrackThirdEtaBin->SetTitle("#pi+ Energy Resolution #eta_{gen} = 2.2; 1/sqrt(E_{gen})  [1/sqrt(GeV)]; #sigma of #DeltaE/E");
  ...
  std::string outThirdGraphName = outputPlotDir + "chgdPionEResoNoTrackThirdEtaBin_nonlinear_horizontal_axis.gif"; 
...
*/
  ...
  TF1 * fitToEtaBinFourResolution = new TF1("fitToEtaBinFourResolution","[0]*x+[1]",0.03,0.20);

  TGraphErrors * chgdPionEResoNoTrackFourthEtaBin = new TGraphErrors(sqrtGenEnergyMeans, withoutTrackerFitSigmasFourthEtaBin, sqrtGenEnergyMeanErrors, withoutTrackerFitSigmaErrorsFourthEtaBin);
  chgdPionEResoNoTrackFourthEtaBin->SetTitle("#pi+ Energy Resolution #eta_{gen} = 2.5; 1/sqrt(E_{gen})  [1/sqrt(GeV)]; #sigma of #DeltaE/E");
  ...
  std::string outFourthGraphName = outputPlotDir + "chgdPionEResoNoTrackFourthEtaBin_nonlinear_horizontal_axis.gif"; 
...
*/
  ...
  TF1 * fitToEtaBinFiveResolution = new TF1("fitToEtaBinFiveResolution","[0]*x+[1]",0.03,0.20);

  TGraphErrors * chgdPionEResoNoTrackFifthEtaBin = new TGraphErrors(sqrtGenEnergyMeans, withoutTrackerFitSigmasFifthEtaBin, sqrtGenEnergyMeanErrors, withoutTrackerFitSigmaErrorsFifthEtaBin);
  chgdPionEResoNoTrackFifthEtaBin->SetTitle("#pi+ Energy Resolution #eta_{gen} = 2.8; 1/sqrt(E_{gen})  [1/sqrt(GeV)]; #sigma of #DeltaE/E");
  ...
  std::string outFifthGraphName = outputPlotDir + "chgdPionEResoNoTrackFifthEtaBin_nonlinear_horizontal_axis.gif"; 
